...
class TinyStoriesDataset(DiskDataset):
    ...
    def get_splits(tokenizer, batch_size):
        return {
            "train": TinyStoriesDataset("train", tokenizer, batch_size, do_shuffle=False, allow_overlap=True),
            "val": TinyStoriesDataset("val", tokenizer, batch_size, do_shuffle=False, allow_overlap=False),
            "test": TinyStoriesDataset("test", tokenizer, batch_size, do_shuffle=False, allow_overlap=False)
        }